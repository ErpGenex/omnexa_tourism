...
## 8) سجل التنفيذ الفعلي (Execution Log)

> يستخدم هذا الجزء أثناء الاختبار الحي لتوثيق نتيجة كل حالة اختبار بشكل قابل للمراجعة والتدقيق.

| TC ID | السيناريو | الدور | الفرع | النتيجة (Pass/Fail) | ملاحظة مختصرة | رقم التذكرة (إن وجد) |
|------|-----------|------|------|----------------------|----------------|------------------------|
| TC-01 | ظهور مساحة Hotel Front Office + KPI/Charts | Front Desk | ____ | ____ | ____ | ____ |
| TC-02 | صلاحيات الفرع (فرع واحد فقط) | Branch Manager | ____ | ____ | ____ | ____ |
| TC-03 | رؤية جميع الفروع | General Manager | ____ | ____ | ____ | ____ |
| TC-04 | دورة الحجز Confirmed → Checked In → Checked Out | Front Desk | ____ | ____ | ____ | ____ |
| TC-05 | إنشاء Guest Folio تلقائي | Front Desk | ____ | ____ | ____ | ____ |
| TC-06 | إنشاء Housekeeping Task تلقائي بعد Checkout | Front Desk | ____ | ____ | ____ | ____ |
| TC-07 | إنشاء Service Order ثم Charge Entry عند Billed | Front Desk | ____ | ____ | ____ | ____ |
| TC-08 | تقرير Arrivals/Departures | Branch Manager | ____ | ____ | ____ | ____ |
| TC-09 | تقرير Service Backlog | Branch Manager | ____ | ____ | ____ | ____ |
| TC-10 | تقرير POS Sales Summary | Accounts User | ____ | ____ | ____ | ____ |
| TC-11 | إشعارات Desk (Online requests / Booking exceptions) | Front Desk | ____ | ____ | ____ | ____ |
| TC-12 | SLA Hourly/Daily + ToDo escalation | General Manager | ____ | ____ | ____ | ____ |

---

## 9) ملخص العيوب (إن وجدت)

| رقم | الوصف | الشدة (Low/Med/High/Critical) | الحالة | المالك | تاريخ الإغلاق المستهدف |
|-----|-------|--------------------------------|--------|--------|--------------------------|
| 1 | ______ | ______ | Open | ______ | ______ |
| 2 | ______ | ______ | Open | ______ | ______ |
| 3 | ______ | ______ | Open | ______ | ______ |

---

## 10) محضر الاعتماد النهائي

- **نسبة النجاح:** ______ %  
- **عدد الحالات المجتازة:** ______  
- **عدد الحالات الفاشلة:** ______  
- **قرار الإدارة:** `Go Live` / `Go Live with Conditions` / `Hold`

**اعتماد مدير الفرع:** ____________________  
**اعتماد المدير العام:** ____________________  
**اعتماد PMO / QA:** ____________________  
